...
public class ColorPalate {
    ...
    public static Color LIGHT_GREEN = new Color(217, 237, 191);
    public static Color LIGHT_BLUE = new Color(172, 226, 225);
    public static Color GREEN2 = new Color(118, 171, 174);
